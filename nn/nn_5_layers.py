...
for iter in range(epochs):
    ...
    print('5-layers network : Minimum error: %.1f, Best accuracy %.1f, Number of Iterations: %d'%(best_cost, best_accuracy, best_iter))
...
plt.savefig('5_layers_networks_fin.png')
